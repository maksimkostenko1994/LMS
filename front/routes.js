angular.module('app').config(['$routeProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
    $routeProvider
      ...
      .when('/user/entrants', {templateUrl: './modules/user/actions/entrants/template.html', controller: 'EntrantController'})
      .when('/user/lecturers', {templateUrl: './modules/user/actions/lecturers/template.html', controller: 'LecturerController'})
